...
@section('content')
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            ...
            <h1 class="text text-light fs-2 fw-bold m-4">Galerie von Author </h1>
                <div class="row">
                        ...
                        <div class="col-4">
                            <div class="card mb-4 box-shadow bg-dark text-light border-secondary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">{{ $Galerie->author }}</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <td><a href="/view/{{ $Photo->id }}" class="btn btn-primary">View</a></td>
                                            <td><a href="/edit/{{ $Galerie->id }}" class="btn btn-warning">Edit</a></td>
