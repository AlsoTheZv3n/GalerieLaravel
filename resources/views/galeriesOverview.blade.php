                    ...
                    @foreach ($Galeries as $Galerie)
                        <div class="col-4">
                            <div class="card mb-4 box-shadow bg-dark text-light border-secondary">
                                <img src="{{ asset('Bilder/' . $Galerie->image_path) }}" class="card-img-top" height="200px"
                                    alt="Galerie">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            ...
                                            <td><a href="/galeries/edit/{{ $Galerie->id }}"
                                                    class="btn btn-success">Edit</a></td>
                                            <td><a href="/photos/create/{{ $Galerie->id }}"
                                                    class="btn btn-warning">Create</a></td>
                                        </div>
                                    </div>
                                </div>
                            </div>
